...
export default async function LoginPage({
  ...
  return (
    <main className="relative grid min-h-screen place-items-center px-4 py-10">
      ...
      />
      <form action={loginAction} className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-7 shadow-[0_24px_48px_-28px_rgba(11,18,32,0.18)]">
        <BrandLogo size="sm" />
        ...
        <p className="mt-5 text-center text-sm text-slate-600">
          ¿No tenés cuenta?{" "}
          <Link className="font-semibold text-emerald-700 hover:text-emerald-800" href="/registro">
            Crear mi álbum
          </Link>
        </p>
      </form>
